...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Crystal Amber Url Shortener web application."
  #
  #
  ...
  #
  # settings.secret_key_base= x-bEiKKlvTOg9KF53Kd0xr6xYYKClWV5PHtCxTFp_Ig
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("crystal-amber-url-shortener.log", "w"))
  #
  #
end
